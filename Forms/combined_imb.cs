...
namespace Graph_theory
{
    class Graph
    {
        ...
        public Graph(string NetID, int[,] x_plus, int[,] x_minus)
        {
            this.NetID = NetID;
        ...
        public void infoTable(Dictionary<string, int> states_hash)
        {

            int itr_print = 0;
            int itr_limit = this.size * (this.size) - 1;
            support e = new support(itr_limit);
            e.iterate_rand(100, this.size, this.pos_target, this.neg_target, this.pos_max, this.neg_max);
        ...
        public void infoTable(support e)
        {
        ...
        class support
        {
            ...
            public void iterate_rand(int n, int size, int pos_target, int neg_target, int pos_max, int neg_max)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    Graph g = new Graph(NetID, x_plus, x_minus);
            ...
            public static void Main()
            {
                ...
                string file_name = "random multiplex.csv";
                string output_file = "result_rand.csv";
                ...
                while (!main_reader.EndOfStream)
                {
                    ...
                    Graph g_ref = new Graph(NetID, x_plus_ref, x_minus_ref);
                    g_ref.infoTable(states_hash);
